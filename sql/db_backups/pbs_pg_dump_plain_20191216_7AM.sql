...
BX 301	BULBS	5	mixed zephyranthes	Pamela Slate	\N	\N	\N	\N
...
BX 358	SEEDS	31	(H. neopardinum x H. papilio) x (H. cybister x H. papilio) F2	Tim Eck	 (H. neopardinum x H. papilio) x (H. cybister x H. papilio) F2; cv ‘Jade Dragon’ (one parent was 7 ½ ” and the other 8”).	\N	\N	\N
...
BX 336	BULBS	7	Zephyranthesr	Lynn Makela	ex Jacala, Mexico, wine-red flowers	\N	\N	\N
